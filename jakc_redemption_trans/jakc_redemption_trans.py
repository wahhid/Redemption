...
class rdm_trans(osv.osv):
    ...
    def _calculate_schemas_total_coupon_and_point(self, cr, uid, trans_id, context=None):
        ...
        for trans_schemas_id in trans_schemas_ids:            
            ...
            if schemas_id.limit_coupon_per_periode > -1:
                periode_coupon = self.periode_total_coupon(cr, uid, schemas_id, customer_id, context=context)
            ...
            if customer_id.email_required and customer_id.receive_email:
                ...
                if schemas_id.limit_point_per_periode > -1:
                    periode_point = self.periode_total_point(cr, uid, schemas_id, customer_id, context=context)
    ...
    def periode_total_coupon(self, cr, uid, schemas_id, customer_id, context=None):
        sql_req = '''
                SELECT 
    ...
    def periode_total_point(self, cr, uid, schemas_id, customer_id, context=None):
        sql_req = '''
                SELECT 
